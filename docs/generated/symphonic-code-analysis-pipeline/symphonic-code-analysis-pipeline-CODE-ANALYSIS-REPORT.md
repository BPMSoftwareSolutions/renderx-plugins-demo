...
**Analysis Date**: 2025-11-28T16:18:15.981Z
**Analysis ID**: 2025-11-28T16:18:14.255Z
...
**Last Scan**: 2025-11-28T16:18:14.967Z
...
- **Contributing Factors**:
  - Test Coverage: 80.1%
  - Documentation: 72.4%
  - Comment Density: 32.9%
  - Complexity Score: 70.2
...
|------|----------|--------|-----|--------|
| Statements | 76.94% | 80% | -3.1% | 🟡 Needs Improvement |
| Branches | 66.30% | 75% | -8.7% | 🔴 Off-track |
| Functions | 84.37% | 80% | 4.4% | 🟡 Needs Improvement |
| Lines | 75.37% | 80% | -4.6% | 🟡 Needs Improvement |
...
**Last Scan**: 2025-11-28T16:18:14.731Z
...
**Generated**: 2025-11-28T16:18:14.753Z
...
**Global Coverage**: 74.63% statements
...
**Average Handler Coverage**: 74.26%
...
- Timestamp: 2025-11-28T16:18:15.603Z
...
**Current Baseline**: 2025-11-28T16:18:15.877Z
...
| Coverage (avg) | 79.34% | 40.25% | - | Monitoring | - |
| Maintainability | 68.54/100 | - | - | Baseline | - |
...
|--------|---------|--------|-----|--------|
| Statements | 76.78% | 85% | 8.22% | 🟡 Close |
| Branches | 81.89% | 85% | 3.11% | 🟡 Close |
| Functions | 75.64% | 90% | 14.36% | 🟡 Close |
| Lines | 74.17% | 85% | 10.83% | ✅ On-target |
...
**Current Maintainability Index**: 68.54/100
...
**Timestamp**: 2025-11-28T16:18:15.884Z
...
- **Movement 3**: Test Coverage Analysis → 76.9% covered
...
### 🟠 HIGH: Branch coverage below acceptable threshold
...
### 1. [P2] 🟡 Increase branch coverage to 80%+
...
### 2. [P2] 🟡 Document architecture patterns for new contributors
...
### 3. [P3] 🟢 Profile and optimize hot paths
...
|---|---:|---:|---:|
| unknown | 147 | 1052 | 86.4% |

### 6.2 Top Handlers by LOC / Complexity
| Handler | Symphony | LOC | Complexity | Coverage | Size | Risk |
|---|---|---:|---:|---:|---|---|
| attachResizeHandlers | unknown | 192 | 0 | 85% | xl | low |
| showSvgNodeOverlay | unknown | 155 | 0 | 86% | xl | low |
| createNode | unknown | 126 | 0 | 91% | xl | low |
| attachLineResizeHandlers | unknown | 96 | 0 | 84% | large | low |
...
| endDrag | unknown | 23 | 0 | 87% | small | low |
| routeSelectionRequest | unknown | 23 | 0 | 85% | small | low |
| startDrag | unknown | 23 | 0 | 84% | small | low |
...
|---|---:|---:|---:|
| attachResizeHandlers | 192 | 0 | 85% |
| showSvgNodeOverlay | 155 | 0 | 86% |
| createNode | 126 | 0 | 91% |
...
**Next Steps**:
1. Branch coverage below acceptable threshold: Add conditional branch tests, improve edge case coverage