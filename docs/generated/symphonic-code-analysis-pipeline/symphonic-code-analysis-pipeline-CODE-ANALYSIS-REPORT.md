# Symphonic Code Analysis Pipeline Code Analysis Report

**Generated**: 2025-11-30T00:58:08.342Z  
**Codebase**: symphonic-code-analysis-pipeline  
...
| Test Coverage | 76.26% | ⚠️  FAIR| Risk: MEDIUM|
| Maintainability | 47.82/100 | 🔴 POOR| Grade: C|
| Code Duplication | 1.80% | ✅ EXCELLENT| Action: Refactor|

---


╔══════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗
║                    SYMPHONIC CODE ANALYSIS ARCHITECTURE - SYMPHONIC CODE ANALYSIS PIPELINE                  ║
...
│  ═════════════════════════════════════════════════════════════════════════════════════════════════════════════   │
│  │ Total Files: 4   │ Total LOC: 64    │ Handlers: 16 │ Avg LOC/Handler: 4.00 │ Coverage: 76.26% │           │
│  ╰─────────────────────────────────────────────────────────────────────────────────────────────────────────────  │
└─────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘
...
║ Health: 64 LOC · Avg Cov 76% · Size Band: SMALL · Risk: HIGH        ║
╠════════════════════════════════════════════════════════════════════╣
║ MOVEMENT MAP                                                        ║
...
║ ─────────────────────────────────────────────────────────────────── ║
║ 1.1  M1  calculateConformityScore        5  S    85% LOW   start    ║
║ 1.2  M1  generateAnalysisReport          4  S    59% HIGH  metrics  ║
║ 1.3  M1  generateTrendReport             4  S    81% LOW   metrics  ║
║ 1.4  M1  validateHandlerMapping          5  S    84% LOW   metrics  ║
║      🎭 Data Baton ▸ handoff: template + CSS metrics                ║
║ 2.1  M2  calculateGapAnalysis            4  S    58% HIGH  style    ║
║ 2.2  M2  measureBranchCoverage           4  S    59% HIGH  style    ║
║ 2.3  M2  measureFunctionCoverage         4  S    79% LOW   style    ║
║ 2.4  M2  measureStatementCoverage        4  S    82% LOW   style    ║
║ 3.1  M3  collectBaseline                 3  S    70% MED   import   ║
║ 3.2  M3  discoverSourceCode              4  S    74% MED   import   ║
║ 3.3  M3  mapBeatsToCode                  3  S    67% MED   import   ║
║ 3.4  M3  scanOrchestrationFiles          4  S    74% MED   payload  ║
║ 4.1  M4  analyzeComplexity               5  S    73% MED   payload  ║
║ 4.2  M4  calculateMaintainability        4  S    68% MED   payload  ║
║ 4.3  M4  countLinesOfCode                3  S    79% LOW   payload  ║
║ 4.4  M4  detectDuplication               5  S    82% LOW   payload  ║
╠════════════════════════ HANDLER PORTFOLIO METRICS ═════════════════╣
║ Size Bands    : Tiny 16 · Small 0 · Medium 0 · Large 0 · XL 0       ║
║ Coverage Dist.: 0–30% 0 · 30–60% 3 · 60–80% 8 · 80–100% 5           ║
║ Risk Summary  : CRITICAL 0 · HIGH 3 · MEDIUM 6 · LOW 7              ║
╚════════════════════════════════════════════════════════════════════╝
        ...
        ╠═══════════════════════════════════════════════════════╣
        ║                                                       ║
        ║  Handlers Analyzed: 16                               ║
        ║  Avg LOC/Handler: 4.00                               ║
        ║  Test Coverage: 76.3%                                  ║
        ║  Duplication: 1.8%                                       ║
        ║  ✓  No God Handlers                              ║
        ║                                                       ║
...
ANALYSIS EXECUTION SUMMARY:
  ✅ Discovered: 4 source files in symphonic-code-analysis-pipeline
  ✅ Analyzed: 16 handler functions with measured LOC (64 total lines)
  ✅ Mapped: Files to orchestration beats
  ✅ Measured: Test coverage (avg 76.3%)
...
NEXT ACTIONS:
  ...
  → Improve test coverage to 80%+ (currently 76.3%)
...
**Last Scan**: 2025-11-30T00:58:07.317Z
...
**Scope**: Full `symphonic-code-analysis-pipeline` domain - all source files in `scripts/symphonies` analyzed

### Coverage Metrics
| Type | Coverage | Target | Gap | Status |
|------|----------|--------|-----|--------|
| Statements | 76.26% | 80% | -3.7% | 🟡 Needs Improvement |
| Branches | 65.05% | 75% | -10.0% | 🔴 Off-track |
| Functions | 76.56% | 80% | -3.4% | 🔴 Off-track |
| Lines | 80.08% | 80% | 0.1% | 🟡 Needs Improvement |
...
**Top Handlers:**
  * calculateConformityScore (generic) — scripts/symphonies/analysis/conformity.ts
  * generateAnalysisReport (output) — scripts/symphonies/analysis/conformity.ts
  * generateTrendReport (output) — scripts/symphonies/analysis/conformity.ts
  * validateHandlerMapping (validation) — scripts/symphonies/analysis/conformity.ts
  * calculateGapAnalysis (generic) — scripts/symphonies/analysis/coverage.ts
  * ... and 11 more

**Measurement**: Source='measured' (real discovered exports via pattern matching)
**Coverage**: Handlers distributed across 4 types
**Last Scan**: 2025-11-30T00:58:07.088Z
...
| Beat Coverage | 100.00% | 100% | ✓ |
| Mapping Confidence | 100.00% | 80%+ | ✓ |
| Distribution | 100.00% | 80%+ | ✓ |

**Metrics:**
- Mapped Handlers: 16/16
- Orphaned Handlers: 0
- Beats with Handlers: 16
- Beats Without Handlers: 0
...
**Mapping Status**: 16/16 handlers have explicit beat mappings. Coverage heatmap reflects current measurement scope.

**Heatmap Terminology**: "Unassigned" in the Coverage Heatmap table refers to handlers without coverage measurement data correlated to specific beats in the current analysis scope, not to unmapped handlers. All 16 handlers have explicit beat assignments in the orchestration-domains.json mapping.

## Coverage by Handler Analysis

### Overall Test Coverage
**Global Coverage**: 80.47% statements
...
**Average Handler Coverage**: 80.24%
...
|------|--------------|----------|--------|
| collect-baseline | 80.42% | 47 | ✅ |
| scan-orchestration-files | 80.27% | 133 | ✅ |
| map-beats-to-code | 79.88% | 11 | ⚠️ |
| validate-handler-mapping | 79.88% | 1 | ⚠️ |
| measure-function-coverage | 79.29% | 1 | ⚠️ |
| count-lines-of-code | 76.97% | 1 | ⚠️ |
| generate-trend-report | 75.68% | 1 | ⚠️ |

### ✅ Well-Tested Handlers (Coverage >= 80%)
| Handler | Coverage | Beat |
|---------|----------|------|
| selectionModel | 85.42% | collect-baseline |
| removeClass | 85.37% | scan-orchestration-files |
| position | 85.33% | scan-orchestration-files |
| async | 85.33% | scan-orchestration-files |
| publishSelectionChanged | 85.22% | collect-baseline |
| getStatistics | 85.22% | collect-baseline |
| updatePosition | 85.1% | scan-orchestration-files |
| validateSequenceShape | 85.05% | collect-baseline |

**Measurement**: Source='measured' (test coverage analysis with handler-beat correlation)
**Timestamp**: 2025-11-30T00:58:07.890Z
...
- Package contains 16 handlers clustered together. Consider extracting into specialized sub-modules or consolidating related handlers.
...
**Impact**: +19 points | -8 (reduce module complexity) | Improved (easier to isolate functionality)
...
- Timestamp: 2025-11-30T00:58:08.099Z
...
**Current Baseline**: 2025-11-30T00:58:08.336Z

### Overall Trend Summary

| Metric | Current | Previous | Change | Trend | Direction |
|--------|---------|----------|--------|-------|-----------|
| Handler Count | 16 | 31 | - | New | - |
| Duplication (blocks) | 562 | 562 | - | Monitoring | - |
| Coverage (avg) | 79.81% | 40.42% | - | Monitoring | - |
| Maintainability | 75.20/100 | - | - | Baseline | - |
| Conformity | 87.50% | - | - | Baseline | - |

### Handler Metrics

**Current State**: 16 handlers discovered

**Handler Tracking:**
- Starting baseline: 16 handlers
- Types detected: 4
- Target for next sprint: 20 (20% growth for enhanced coverage)
- Health score: 54/100 (POOR - focus on distribution)

**Expected Evolution**:
- Week 4: 17 handlers (Type-specific handlers added)
- Week 8: 19 handlers (Enhanced testing harness)
- Week 12: 21 handlers (Full handler decomposition)
...
|--------|---------|--------|-----|--------|
| Statements | 78.53% | 85% | 6.47% | 🟡 Close |
| Branches | 81.09% | 85% | 3.91% | 🟡 Close |
| Functions | 87.08% | 90% | 2.92% | 🟡 Close |
| Lines | 84.44% | 85% | 0.56% | ✅ On-target |
...
**Current Maintainability Index**: 75.20/100
...
**Timestamp**: 2025-11-30T00:58:08.342Z
...
✓ Conformity (87.50%) ✅
✓ Coverage - Orchestration Suite (76.26%) ❌
✓ Handler Scanning (16 handlers discovered) ✅
...
- **JSON Analysis**: symphonic-code-analysis-pipeline-code-analysis-2025-11-30T00-58-06-195Z.json
- **Coverage Summary**: symphonic-code-analysis-pipeline-coverage-summary-2025-11-30T00-58-06-195Z.json
- **Per-Beat Metrics**: symphonic-code-analysis-pipeline-per-beat-metrics-2025-11-30T00-58-06-195Z.csv
- **Trend Analysis**: symphonic-code-analysis-pipeline-trends-2025-11-30T00-58-06-195Z.json
