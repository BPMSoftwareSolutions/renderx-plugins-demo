...
**Generated**: 2025-11-29T18:36:21.107Z  
...
| Test Coverage | 74.73% | ⚠️  FAIR| Risk: MEDIUM|
| Maintainability | 55.98/100 | 🔴 POOR| Grade: C|
...
│  ═════════════════════════════════════════════════════════════════════════════════════════════════════════════   │
│  │ Total Files: 787 │ Total LOC: 5045  │ Handlers: 515│ Avg LOC/Handler: 9.80 │ Coverage: 74.73% │           │
│  ╰─────────────────────────────────────────────────────────────────────────────────────────────────────────────  │
└─────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘
...
║ Health: 333 LOC · Avg Cov 75% · Size Band: LARGE · Risk: HIGH       ║
╠════════════════════════════════════════════════════════════════════╣
║ MOVEMENT MAP                                                        ║
...
║ ─────────────────────────────────────────────────────────────────── ║
║ 1.1  M1  resolveTemplate                11  S    67% MED   start    ║
║ 1.2  M1  injectCssFallback               9  S    69% MED   metrics  ║
║ 1.3  M1  injectRawCss                   11  S    72% MED   metrics  ║
║ 1.4  M1  appendTo                       10  S    69% MED   metrics  ║
║      🎭 Data Baton ▸ handoff: template + CSS metrics                ║
║ 2.1  M2  applyClasses                   10  S    60% MED   style    ║
║ 2.2  M2  applyInlineStyle                9  S    55% HIGH  style    ║
║ 2.3  M2  createElementWithId             9  S    66% MED   style    ║
║ 2.4  M2  getCanvasOrThrow               11  S    81% LOW   style    ║
║ 3.1  M3  attachStandardImportInteracti   8  S    60% MED   import   ║
║ 3.2  M3  createFromImportRecord         11  S    67% MED   import   ║
║ 3.3  M3  toCreatePayloadFromData        11  S    58% HIGH  import   ║
║ 3.4  M3  transformClipboardToCreatePay   8  S    83% LOW   payload  ║
║ 4.1  M4  transformImportToCreatePayloa  10  S    78% LOW   payload  ║
║ 4.2  M4  attachDrag                      8  S    57% HIGH  payload  ║
║ 4.3  M4  attachSelection                12  S    71% MED   payload  ║
║ 4.4  M4  attachSvgNodeClick             11  S    81% LOW   payload  ║
║ 5.1  M5  derivePath                     11  S    78% LOW   payload  ║
║ 5.2  M5  registerInstance               11  S    65% MED   payload  ║
║ 5.3  M5  notifyUi                        9  S    78% LOW   payload  ║
║ 5.4  M5  cleanupReactRoot                9  S    59% HIGH  payload  ║
║ 6.1  M6  compileReactCode                9  S    69% MED   payload  ║
║ 6.2  M6  escapeHtml                      8  S    85% LOW   payload  ║
║ 6.3  M6  exposeEventRouterToReact        9  S    65% MED   payload  ║
║ 6.4  M6  getDiagnosticsEmitter          11  S    62% MED   payload  ║
║ 7.1  M7  getMetricsCollector             9  S    80% LOW   payload  ║
║ 7.2  M7  renderReact                     9  S    66% MED   payload  ║
║ 7.3  M7  applyContentProperties          8  S    62% MED   payload  ║
║ 7.4  M7  createNode                     10  S    59% HIGH  payload  ║
║ 8.1  M8  create                          9  S    69% MED   payload  ║
║ 8.2  M8  computeCssVarBlock              9  S    64% MED   payload  ║
║ 8.3  M8  computeInlineStyle              9  S    76% LOW   payload  ║
║ 8.4  M8  computeInstanceClass            9  S    55% HIGH  payload  ║
║ 9.1  M9  validateReactCode              11  S    58% HIGH  payload  ║
║ 9.2  M9  validateReactCodeOrThrow       11  S    67% MED   payload  ║
╠════════════════════════ HANDLER PORTFOLIO METRICS ═════════════════╣
...
║ Health: 274 LOC · Avg Cov 75% · Size Band: MEDIUM · Risk: HIGH      ║
╠════════════════════════════════════════════════════════════════════╣
║ MOVEMENT MAP                                                        ║
║   M1 Discovery   →   M2 Metrics   →   M3 Coverage                   ║
║   Beats 1.1–1.4      Beats 2.1–2.4      Beats 3.1–3.4               ║
...
║ Beat Mov Handler                      LOC  Sz  Cov  Risk  Baton     ║
║ ─────────────────────────────────────────────────────────────────── ║
║ 1.1  M1  ensureOverlayCss               10  S    73% MED   start    ║
║ 1.2  M1  applyOverlayRectForEl          10  S    66% MED   metrics  ║
║ 1.3  M1  ensureOverlay                  10  S    69% MED   metrics  ║
║ 1.4  M1  getCanvasOrThrow                8  S    73% MED   metrics  ║
║      🎭 Data Baton ▸ handoff: template + CSS metrics                ║
║ 2.1  M2  getCanvasRect                   9  S    79% LOW   style    ║
║ 2.2  M2  createOverlayStructure         11  S    83% LOW   style    ║
║ 2.3  M2  readCssNumber                  11  S    76% LOW   style    ║
║ 2.4  M2  resolveEndpoints               11  S    64% MED   style    ║
║ 3.1  M3  attachAdvancedLineManipHandle   9  S    78% LOW   import   ║
║ 3.2  M3  ensureAdvancedLineCss           9  S    69% MED   import   ║
║ 3.3  M3  ensureAdvancedLineOverlayFor   11  S    57% HIGH  import   ║
║ 3.4  M3  attachLineResizeHandlers       11  S    78% LOW   payload  ║
║ 4.1  M4  ensureLineCss                   9  S    73% MED   payload  ║
║ 4.2  M4  ensureLineOverlayFor            8  S    74% MED   payload  ║
║ 4.3  M4  attachResizeHandlers            9  S    78% LOW   payload  ║
║ 4.4  M4  getDiagnosticsEmitter          11  S    56% HIGH  payload  ║
║ 5.1  M5  getResizeConfig                10  S    56% HIGH  payload  ║
║ 5.2  M5  readNumericPx                  11  S    63% MED   payload  ║
║ 5.3  M5  configureHandlesVisibility     10  S    84% LOW   payload  ║
║ 5.4  M5  deriveSelectedId               11  S    66% MED   payload  ║
║ 6.1  M6  select                          9  S    84% LOW   payload  ║
║ 6.2  M6  hideSelectionOverlay            8  S    84% LOW   payload  ║
║ 6.3  M6  notifyUi                        8  S    68% MED   payload  ║
║ 6.4  M6  publishSelectionChanged         9  S    79% LOW   payload  ║
║ 7.1  M7  routeSelectionRequest          10  S    85% LOW   payload  ║
║ 7.2  M7  showSelectionOverlay            9  S    82% LOW   payload  ║
║ 7.3  M7  select.svg_node                 8  S    60% MED   payload  ║
║ 7.4  M7  showSvgNodeOverlay              9  S    74% MED   payload  ║
╠════════════════════════ HANDLER PORTFOLIO METRICS ═════════════════╣
║ Size Bands    : Tiny 14 · Small 14 · Medium 0 · Large 0 · XL 0      ║
║ Coverage Dist.: 0–30% 0 · 30–60% 3 · 60–80% 19 · 80–100% 6          ║
...
║ Health: 235 LOC · Avg Cov 75% · Size Band: MEDIUM · Risk: HIGH      ║
╠════════════════════════════════════════════════════════════════════╣
║ MOVEMENT MAP                                                        ║
║   M1 Discovery   →   M2 Metrics   →   M3 Coverage                   ║
║   Beats 1.1–1.4      Beats 2.1–2.4      Beats 3.1–3.4               ║
...
║ Beat Mov Handler                      LOC  Sz  Cov  Risk  Baton     ║
║ ─────────────────────────────────────────────────────────────────── ║
║ 1.1  M1  awaitRefresh                    9  S    66% MED   start    ║
║ 1.2  M1  dispatchField                  12  S    65% MED   metrics  ║
║ 1.3  M1  generateFields                  9  S    58% HIGH  metrics  ║
║ 1.4  M1  generateSections                9  S    83% LOW   metrics  ║
║      🎭 Data Baton ▸ handoff: template + CSS metrics                ║
║ 2.1  M2  initConfig                     11  S    57% HIGH  style    ║
║ 2.2  M2  initMovement                   11  S    65% MED   style    ║
║ 2.3  M2  initResolver                   10  S    76% LOW   style    ║
║ 2.4  M2  loadSchemas                     8  S    62% MED   style    ║
║ 3.1  M3  mergeErrors                     8  S    77% LOW   import   ║
║ 3.2  M3  notifyReady                    10  S    73% MED   import   ║
║ 3.3  M3  prepareField                   10  S    71% MED   import   ║
║ 3.4  M3  registerObservers              10  S    79% LOW   payload  ║
║ 4.1  M4  renderView                      8  S    70% MED   payload  ║
║ 4.2  M4  setDirty                        8  S    58% HIGH  payload  ║
║ 4.3  M4  toggleSection                  11  S    58% HIGH  payload  ║
║ 4.4  M4  updateView                      8  S    62% MED   payload  ║
║ 5.1  M5  validateField                   9  S    57% HIGH  payload  ║
║ 5.2  M5  ui.symphony                    10  S    58% HIGH  payload  ║
║ 5.3  M5  coerceTheme                    10  S    70% MED   payload  ║
║ 5.4  M5  getCurrentTheme                11  S    73% MED   payload  ║
║ 6.1  M6  safeGetStoredTheme              8  S    55% HIGH  payload  ║
║ 6.2  M6  safeSetStoredTheme              9  S    55% HIGH  payload  ║
║ 6.3  M6  toggleTheme                     9  S    69% MED   payload  ║
║ 6.4  M6  ui.symphony                     8  S    56% HIGH  payload  ║
╠════════════════════════ HANDLER PORTFOLIO METRICS ═════════════════╣
║ Size Bands    : Tiny 13 · Small 11 · Medium 0 · Large 0 · XL 0      ║
║ Coverage Dist.: 0–30% 0 · 30–60% 9 · 60–80% 14 · 80–100% 1          ║
║ Risk Summary  : CRITICAL 0 · HIGH 9 · MEDIUM 11 · LOW 4             ║
╚════════════════════════════════════════════════════════════════════╝
...
║ Health: 137 LOC · Avg Cov 75% · Size Band: SMALL · Risk: HIGH       ║
╠════════════════════════════════════════════════════════════════════╣
║ MOVEMENT MAP                                                        ║
║   M1 Discovery   →   M2 Metrics   →   M3 Coverage                   ║
║   Beats 1.1–1.4      Beats 2.1–2.4      Beats 3.1–3.4               ║
...
║ Beat Mov Handler                      LOC  Sz  Cov  Risk  Baton     ║
║ ─────────────────────────────────────────────────────────────────── ║
║ 1.1  M1  collectCssClasses               9  S    59% HIGH  start    ║
║ 1.2  M1  discoverComponentsFromDom       9  S    72% MED   metrics  ║
║ 1.3  M1  downloadUiFile                  8  S    76% LOW   metrics  ║
║ 1.4  M1  exportSvgToGif                 12  S    65% MED   metrics  ║
║      🎭 Data Baton ▸ handoff: template + CSS metrics                ║
║ 2.1  M2  makeGifEncoder                 10  S    72% MED   style    ║
║ 2.2  M2  export.gif.symphony            10  S    84% LOW   style    ║
║ 2.3  M2  queryAllComponents             11  S    66% MED   style    ║
║ 2.4  M2  createMP4Encoder                8  S    57% HIGH  style    ║
║ 3.1  M3  exportSvgToMp4                  9  S    79% LOW   import   ║
║ 3.2  M3  export.mp4.symphony             8  S    60% MED   import   ║
║ 3.3  M3  buildUiFileContent             11  S    61% MED   import   ║
║ 3.4  M3  collectLayoutData              11  S    76% LOW   payload  ║
║ 4.1  M4  extractElementContent          10  S    82% LOW   payload  ║
║ 4.2  M4  export.symphony                 9  S    82% LOW   payload  ║
╠════════════════════════ HANDLER PORTFOLIO METRICS ═════════════════╣
...
║ Beat Mov Handler                      LOC  Sz  Cov  Risk  Baton     ║
║ ─────────────────────────────────────────────────────────────────── ║
║ 1.1  M1  bootstrapLogging                8  S    72% MED   start    ║
║ 1.2  M1  checkExistingInstance           8  S    82% LOW   metrics  ║
║ 1.3  M1  connectSystems                 11  S    67% MED   metrics  ║
║ 1.4  M1  createConductor                10  S    76% LOW   metrics  ║
║      🎭 Data Baton ▸ handoff: template + CSS metrics                ║
║ 2.1  M2  exposeFacade                    8  S    83% LOW   style    ║
║ 2.2  M2  getCommunicationSystemInstanc   8  S    80% LOW   style    ║
║ 2.3  M2  initialize                      9  S    68% MED   style    ║
║ 2.4  M2  isCommunicationSystemInitiali   9  S    78% LOW   style    ║
║ 3.1  M3  loadSequences                   9  S    84% LOW   import   ║
║ 3.2  M3  markInitialized                10  S    60% MED   import   ║
║ 3.3  M3  notifyReady                    11  S    71% MED   import   ║
║ 3.4  M3  resetCommunicationSystem        8  S    82% LOW   payload  ║
║ 4.1  M4  validateEnvironment            10  S    68% MED   payload  ║
║ 4.2  M4  validateRegistrations          12  S    83% LOW   payload  ║
╠════════════════════════ HANDLER PORTFOLIO METRICS ═════════════════╣
...
║ Health: 127 LOC · Avg Cov 75% · Size Band: SMALL · Risk: HIGH       ║
╠════════════════════════════════════════════════════════════════════╣
║ MOVEMENT MAP                                                        ║
║   M1 Discovery   →   M2 Metrics   →   M3 Coverage                   ║
║   Beats 1.1–1.4      Beats 2.1–2.4      Beats 3.1–3.4               ║
...
║ Beat Mov Handler                      LOC  Sz  Cov  Risk  Baton     ║
║ ─────────────────────────────────────────────────────────────────── ║
║ 1.1  M1  endDrag                         9  S    60% MED   start    ║
║ 1.2  M1  forwardToControlPanel          11  S    82% LOW   metrics  ║
║ 1.3  M1  drag                           11  S    69% MED   metrics  ║
║ 1.4  M1  startDrag                       8  S    84% LOW   metrics  ║
║      🎭 Data Baton ▸ handoff: template + CSS metrics                ║
║ 2.1  M2  updatePosition                 11  S    76% LOW   style    ║
║ 2.2  M2  drag.symphony                  10  S    65% MED   style    ║
║ 2.3  M2  applyTemplateStyles            11  S    59% HIGH  style    ║
║ 2.4  M2  computeCursorOffsets            8  S    78% LOW   style    ║
║ 3.1  M3  computeGhostSize               11  S    78% LOW   import   ║
║ 3.2  M3  createGhostContainer            9  S    80% LOW   import   ║
║ 3.3  M3  ensurePayload                   9  S    77% LOW   import   ║
║ 3.4  M3  installDragImage               10  S    64% MED   payload  ║
║ 4.1  M4  renderTemplatePreview          11  S    58% HIGH  payload  ║
╠════════════════════════ HANDLER PORTFOLIO METRICS ═════════════════╣
║ Size Bands    : Tiny 5 · Small 8 · Medium 0 · Large 0 · XL 0        ║
║ Coverage Dist.: 0–30% 0 · 30–60% 2 · 60–80% 8 · 80–100% 3           ║
║ Risk Summary  : CRITICAL 0 · HIGH 2 · MEDIUM 4 · LOW 7              ║
╚════════════════════════════════════════════════════════════════════╝
...
║ Health: 118 LOC · Avg Cov 75% · Size Band: SMALL · Risk: HIGH       ║
╠════════════════════════════════════════════════════════════════════╣
║ MOVEMENT MAP                                                        ║
║   M1 Discovery   →   M2 Metrics   →   M3 Coverage                   ║
║   Beats 1.1–1.4      Beats 2.1–2.4      Beats 3.1–3.4               ║
...
║ Beat Mov Handler                      LOC  Sz  Cov  Risk  Baton     ║
║ ─────────────────────────────────────────────────────────────────── ║
║ 1.1  M1  resize.end.symphony            11  S    57% HIGH  start    ║
║ 1.2  M1  resize.move.symphony            8  S    58% HIGH  metrics  ║
║ 1.3  M1  clamp                          12  S    85% LOW   metrics  ║
║ 1.4  M1  endResize                      12  S    59% HIGH  metrics  ║
║      🎭 Data Baton ▸ handoff: template + CSS metrics                ║
║ 2.1  M2  getResizeConfig                 9  S    81% LOW   style    ║
║ 2.2  M2  resize                         11  S    67% MED   style    ║
║ 2.3  M2  readCssNumber                  12  S    75% LOW   style    ║
║ 2.4  M2  startResize                    11  S    55% HIGH  style    ║
║ 3.1  M3  updateSize                     11  S    61% MED   import   ║
║ 3.2  M3  writeCssNumber                  9  S    69% MED   import   ║
║ 3.3  M3  resize.start.symphony          11  S    66% MED   import   ║
║ 3.4  M3  resize.symphony                12  S    78% LOW   payload  ║
╠════════════════════════ HANDLER PORTFOLIO METRICS ═════════════════╣
║ Size Bands    : Tiny 3 · Small 9 · Medium 0 · Large 0 · XL 0        ║
║ Coverage Dist.: 0–30% 0 · 30–60% 4 · 60–80% 6 · 80–100% 2           ║
║ Risk Summary  : CRITICAL 0 · HIGH 4 · MEDIUM 4 · LOW 4              ║
╚════════════════════════════════════════════════════════════════════╝
...
║ Health: 108 LOC · Avg Cov 75% · Size Band: SMALL · Risk: HIGH       ║
╠════════════════════════════════════════════════════════════════════╣
║ MOVEMENT MAP                                                        ║
║   M1 Discovery   →   M2 Metrics   →   M3 Coverage                   ║
...
║ Beat Mov Handler                      LOC  Sz  Cov  Risk  Baton     ║
║ ─────────────────────────────────────────────────────────────────── ║
║ 1.1  M1  enhanceLine                     8  S    82% LOW   start    ║
║ 1.2  M1  ensureLineMarkers              10  S    70% MED   metrics  ║
║ 1.3  M1  ensureCurve                    11  S    61% MED   metrics  ║
║ 1.4  M1  ensureLine                      9  S    72% MED   metrics  ║
║      🎭 Data Baton ▸ handoff: template + CSS metrics                ║
║ 2.1  M2  fmt                             8  S    63% MED   style    ║
║ 2.2  M2  readBooleanVar                 10  S    60% MED   style    ║
║ 2.3  M2  readCssNumber                  11  S    82% LOW   style    ║
║ 2.4  M2  recomputeLineSvg               10  S    77% LOW   style    ║
║ 3.1  M3  resolveSize                     9  S    73% MED   import   ║
║ 3.2  M3  toVbX                          11  S    69% MED   import   ║
║ 3.3  M3  toVbY                           8  S    61% MED   import   ║
╠════════════════════════ HANDLER PORTFOLIO METRICS ═════════════════╣
...
║ Package: musical-conductor                                          ║
║ Scope : 1 Symphony · 3 Movements · 11 Beats · 11 Handlers           ║
║ Health: 108 LOC · Avg Cov 75% · Size Band: SMALL · Risk: LOW        ║
╠════════════════════════════════════════════════════════════════════╣
║ MOVEMENT MAP                                                        ║
║   M1 Discovery   →   M2 Metrics   →   M3 Coverage                   ║
║   Beats 1.1–1.4      Beats 2.1–2.4      Beats 3.1–3.3               ║
...
║ Beat Mov Handler                      LOC  Sz  Cov  Risk  Baton     ║
║ ─────────────────────────────────────────────────────────────────── ║
║ 1.1  M1  checkResources                  9  S    59% HIGH  start    ║
║ 1.2  M1  cleanupResources                9  S    63% MED   metrics  ║
║ 1.3  M1  enqueueSequence                 9  S    83% LOW   metrics  ║
║ 1.4  M1  handleBeatComplete             11  S    63% MED   metrics  ║
║      🎭 Data Baton ▸ handoff: template + CSS metrics                ║
║ 2.1  M2  execute_sequence               10  S    80% LOW   style    ║
║ 2.2  M2  notifyComplete                  8  S    72% MED   style    ║
║ 2.3  M2  processBeat                    11  S    60% MED   style    ║
║ 2.4  M2  recordMetrics                  12  S    56% HIGH  style    ║
║ 3.1  M3  startExecution                 10  S    75% LOW   import   ║
║ 3.2  M3  updateStatistics                9  S    59% HIGH  import   ║
║ 3.3  M3  validateRequest                12  S    63% MED   import   ║
╠════════════════════════ HANDLER PORTFOLIO METRICS ═════════════════╣
║ Size Bands    : Tiny 5 · Small 6 · Medium 0 · Large 0 · XL 0        ║
║ Coverage Dist.: 0–30% 0 · 30–60% 3 · 60–80% 6 · 80–100% 2           ║
║ Risk Summary  : CRITICAL 0 · HIGH 3 · MEDIUM 5 · LOW 3              ║
╚════════════════════════════════════════════════════════════════════╝
...
║ Beat Mov Handler                      LOC  Sz  Cov  Risk  Baton     ║
║ ─────────────────────────────────────────────────────────────────── ║
║ 1.1  M1  checkEventBusHealth             9  S    75% LOW   start    ║
║ 1.2  M1  checkExecutionHealth            9  S    66% MED   metrics  ║
║ 1.3  M1  generateStatusReport            9  S    75% LOW   metrics  ║
║ 1.4  M1  getConductorStatus              9  S    78% LOW   metrics  ║
║      🎭 Data Baton ▸ handoff: template + CSS metrics                ║
║ 2.1  M2  getDuplicationReport            9  S    80% LOW   style    ║
║ 2.2  M2  getPerformanceMetrics          11  S    80% LOW   style    ║
║ 2.3  M2  getQueueStatus                  9  S    67% MED   style    ║
║ 2.4  M2  getSequenceCount               11  S    59% HIGH  style    ║
║ 3.1  M3  getStatistics                  12  S    57% HIGH  import   ║
║ 3.2  M3  monitor                         9  S    68% MED   import   ║
║ 3.3  M3  logHealthSummary                8  S    60% MED   import   ║
╠════════════════════════ HANDLER PORTFOLIO METRICS ═════════════════╣
...
║ Beat Mov Handler                      LOC  Sz  Cov  Risk  Baton     ║
║ ─────────────────────────────────────────────────────────────────── ║
║ 1.1  M1  checkManifest                   8  S    70% MED   start    ║
║ 1.2  M1  checkResourceRequirements       9  S    84% LOW   metrics  ║
║ 1.3  M1  checkSPACompliance             10  S    64% MED   metrics  ║
║ 1.4  M1  generateValidationReport        9  S    71% MED   metrics  ║
║      🎭 Data Baton ▸ handoff: template + CSS metrics                ║
║ 2.1  M2  validate_plugin                 8  S    78% LOW   style    ║
║ 2.2  M2  logResults                     11  S    57% HIGH  style    ║
║ 2.3  M2  validateHandlerContracts        9  S    55% HIGH  style    ║
║ 2.4  M2  validatePluginShape            10  S    81% LOW   style    ║
║ 3.1  M3  validatePriorities             10  S    70% MED   import   ║
║ 3.2  M3  verifyBeatMapping              10  S    70% MED   import   ║
║ 3.3  M3  verifyExports                   8  S    61% MED   import   ║
╠════════════════════════ HANDLER PORTFOLIO METRICS ═════════════════╣
...
║ Health: 88 LOC · Avg Cov 75% · Size Band: SMALL · Risk: MEDIUM      ║
╠════════════════════════════════════════════════════════════════════╣
║ MOVEMENT MAP                                                        ║
║   M1 Discovery   →   M2 Metrics   →   M3 Coverage                   ║
...
║ Beat Mov Handler                      LOC  Sz  Cov  Risk  Baton     ║
║ ─────────────────────────────────────────────────────────────────── ║
║ 1.1  M1  line.manip.end.symphony        10  S    58% HIGH  start    ║
║ 1.2  M1  line.manip.move.symphony        8  S    61% MED   metrics  ║
║ 1.3  M1  endLineManip                   11  S    55% HIGH  metrics  ║
║ 1.4  M1  moveLineManip                   9  S    59% HIGH  metrics  ║
║      🎭 Data Baton ▸ handoff: template + CSS metrics                ║
║ 2.1  M2  startLineManip                  9  S    66% MED   style    ║
║ 2.2  M2  updateCurve                     9  S    57% HIGH  style    ║
║ 2.3  M2  updateEndpoint                 12  S    63% MED   style    ║
║ 2.4  M2  updateRotate                   11  S    60% MED   style    ║
║ 3.1  M3  line.manip.start.symphony       9  S    85% LOW   import   ║
╠════════════════════════ HANDLER PORTFOLIO METRICS ═════════════════╣
║ Size Bands    : Tiny 5 · Small 4 · Medium 0 · Large 0 · XL 0        ║
║ Coverage Dist.: 0–30% 0 · 30–60% 4 · 60–80% 4 · 80–100% 1           ║
║ Risk Summary  : CRITICAL 0 · HIGH 4 · MEDIUM 4 · LOW 1              ║
╚════════════════════════════════════════════════════════════════════╝
...
║ Beat Mov Handler                      LOC  Sz  Cov  Risk  Baton     ║
║ ─────────────────────────────────────────────────────────────────── ║
║ 1.1  M1  applyCssClassToElement          9  S    60% MED   start    ║
║ 1.2  M1  createCssClass                 11  S    69% MED   metrics  ║
║ 1.3  M1  deleteCssClass                  9  S    55% HIGH  metrics  ║
║ 1.4  M1  getCssClass                    12  S    68% MED   metrics  ║
║      🎭 Data Baton ▸ handoff: template + CSS metrics                ║
║ 2.1  M2  listCssClasses                 10  S    57% HIGH  style    ║
║ 2.2  M2  removeClassFromAllElements      9  S    71% MED   style    ║
║ 2.3  M2  removeCssClassFromElement       9  S    70% MED   style    ║
║ 2.4  M2  updateCssClass                  9  S    57% HIGH  style    ║
║ 3.1  M3  css_management.symphony        10  S    78% LOW   import   ║
╠════════════════════════ HANDLER PORTFOLIO METRICS ═════════════════╣
║ Size Bands    : Tiny 5 · Small 4 · Medium 0 · Large 0 · XL 0        ║
║ Coverage Dist.: 0–30% 0 · 30–60% 3 · 60–80% 6 · 80–100% 0           ║
║ Risk Summary  : CRITICAL 0 · HIGH 3 · MEDIUM 5 · LOW 1              ║
╚════════════════════════════════════════════════════════════════════╝
...
║ Package: musical-conductor                                          ║
║ Scope : 1 Symphony · 3 Movements · 9 Beats · 9 Handlers             ║
║ Health: 88 LOC · Avg Cov 75% · Size Band: SMALL · Risk: LOW         ║
╠════════════════════════════════════════════════════════════════════╣
║ MOVEMENT MAP                                                        ║
║   M1 Discovery   →   M2 Metrics   →   M3 Coverage                   ║
║   Beats 1.1–1.4      Beats 2.1–2.4      Beats 3.1–3.1               ║
...
║ Beat Mov Handler                      LOC  Sz  Cov  Risk  Baton     ║
║ ─────────────────────────────────────────────────────────────────── ║
║ 1.1  M1  checkDuplicates                10  S    81% LOW   start    ║
║ 1.2  M1  register_sequence              10  S    58% HIGH  metrics  ║
║ 1.3  M1  logRegistrationDetails          9  S    84% LOW   metrics  ║
║ 1.4  M1  notifyRegistered               10  S    81% LOW   metrics  ║
║      🎭 Data Baton ▸ handoff: template + CSS metrics                ║
║ 2.1  M2  registerWithRegistry            9  S    79% LOW   style    ║
║ 2.2  M2  updateEventMappings            11  S    85% LOW   style    ║
║ 2.3  M2  validateBeats                   9  S    69% MED   style    ║
║ 2.4  M2  validateSequenceShape          10  S    56% HIGH  style    ║
║ 3.1  M3  verifyAvailability             10  S    79% LOW   import   ║
╠════════════════════════ HANDLER PORTFOLIO METRICS ═════════════════╣
║ Size Bands    : Tiny 3 · Small 6 · Medium 0 · Large 0 · XL 0        ║
║ Coverage Dist.: 0–30% 0 · 30–60% 2 · 60–80% 3 · 80–100% 4           ║
║ Risk Summary  : CRITICAL 0 · HIGH 2 · MEDIUM 1 · LOW 6              ║
╚════════════════════════════════════════════════════════════════════╝
...
║ Health: 78 LOC · Avg Cov 75% · Size Band: SMALL · Risk: HIGH        ║
╠════════════════════════════════════════════════════════════════════╣
║ MOVEMENT MAP                                                        ║
║   M1 Discovery   →   M2 Metrics   →   M3 Coverage                   ║
║   Beats 1.1–1.4      Beats 2.1–2.4      Beats 3.1–3.1               ║
...
║ Beat Mov Handler                      LOC  Sz  Cov  Risk  Baton     ║
║ ─────────────────────────────────────────────────────────────────── ║
║ 1.1  M1  clearAllSelections             11  S    58% HIGH  start    ║
║ 1.2  M1  deselectComponent               9  S    83% LOW   metrics  ║
║ 1.3  M1  deselect                        9  S    77% LOW   metrics  ║
║ 1.4  M1  hideAllOverlays                 8  S    75% LOW   metrics  ║
║      🎭 Data Baton ▸ handoff: template + CSS metrics                ║
║ 2.1  M2  hideOverlayById                 9  S    56% HIGH  style    ║
║ 2.2  M2  publishDeselectionChanged      12  S    67% MED   style    ║
║ 2.3  M2  publishSelectionsCleared        9  S    81% LOW   style    ║
║ 2.4  M2  routeDeselectionRequest        11  S    82% LOW   style    ║
╠════════════════════════ HANDLER PORTFOLIO METRICS ═════════════════╣
║ Size Bands    : Tiny 5 · Small 3 · Medium 0 · Large 0 · XL 0        ║
║ Coverage Dist.: 0–30% 0 · 30–60% 2 · 60–80% 3 · 80–100% 3           ║
║ Risk Summary  : CRITICAL 0 · HIGH 2 · MEDIUM 1 · LOW 5              ║
╚════════════════════════════════════════════════════════════════════╝
...
║ Package: canvas-component                                           ║
║ Scope : 1 Symphony · 3 Movements · 8 Beats · 8 Handlers             ║
║ Health: 78 LOC · Avg Cov 75% · Size Band: SMALL · Risk: MEDIUM      ║
╠════════════════════════════════════════════════════════════════════╣
║ MOVEMENT MAP                                                        ║
║   M1 Discovery   →   M2 Metrics   →   M3 Coverage                   ║
║   Beats 1.1–1.4      Beats 2.1–2.4      Beats 3.1–3.1               ║
...
║ Beat Mov Handler                      LOC  Sz  Cov  Risk  Baton     ║
║ ─────────────────────────────────────────────────────────────────── ║
║ 1.1  M1  injectCssClasses               10  S    80% LOW   start    ║
║ 1.2  M1  openUiFile                     10  S    69% MED   metrics  ║
║ 1.3  M1  registerInstances              11  S    60% MED   metrics  ║
║ 1.4  M1  applyHierarchyAndOrder          8  S    57% HIGH  metrics  ║
║      🎭 Data Baton ▸ handoff: template + CSS metrics                ║
║ 2.1  M2  createComponentsSequentially    8  S    56% HIGH  style    ║
║ 2.2  M2  loadComponentTemplate          10  S    74% MED   style    ║
║ 2.3  M2  parseUiFile                    12  S    62% MED   style    ║
║ 2.4  M2  import.symphony                11  S    79% LOW   style    ║
╠════════════════════════ HANDLER PORTFOLIO METRICS ═════════════════╣
...
║ Health: 69 LOC · Avg Cov 75% · Size Band: SMALL · Risk: MEDIUM      ║
╠════════════════════════════════════════════════════════════════════╣
║ MOVEMENT MAP                                                        ║
║   M1 Discovery   →   M2 Metrics   →   M3 Coverage                   ║
║   Beats 1.1–1.4      Beats 2.1–2.4      Beats 3.1–3.1               ║
...
║ Beat Mov Handler                      LOC  Sz  Cov  Risk  Baton     ║
║ ─────────────────────────────────────────────────────────────────── ║
║ 1.1  M1  resize.line.end.symphony       10  S    59% HIGH  start    ║
║ 1.2  M1  resize.line.move.symphony      11  S    71% MED   metrics  ║
║ 1.3  M1  endLineResize                   9  S    73% MED   metrics  ║
║ 1.4  M1  resize.line                     8  S    75% LOW   metrics  ║
║      🎭 Data Baton ▸ handoff: template + CSS metrics                ║
║ 2.1  M2  startLineResize                 8  S    57% HIGH  style    ║
║ 2.2  M2  updateLine                      9  S    63% MED   style    ║
║ 2.3  M2  resize.line.start.symphony     11  S    72% MED   style    ║
╠════════════════════════ HANDLER PORTFOLIO METRICS ═════════════════╣
...
║ Beat Mov Handler                      LOC  Sz  Cov  Risk  Baton     ║
║ ─────────────────────────────────────────────────────────────────── ║
║ 1.1  M1  refreshControlPanel             8  S    83% LOW   start    ║
║ 1.2  M1  updateAttribute                 9  S    58% HIGH  metrics  ║
║ 1.3  M1  refreshControlPanel             9  S    67% MED   metrics  ║
║ 1.4  M1  updateSvgNodeAttribute         11  S    61% MED   metrics  ║
║      🎭 Data Baton ▸ handoff: template + CSS metrics                ║
║ 2.1  M2  update.svg_node.symphony       11  S    61% MED   style    ║
║ 2.2  M2  updateFromElement              11  S    74% MED   style    ║
║ 2.3  M2  update.symphony                10  S    74% MED   style    ║
╠════════════════════════ HANDLER PORTFOLIO METRICS ═════════════════╣
...
║ Health: 59 LOC · Avg Cov 75% · Size Band: SMALL · Risk: LOW         ║
╠════════════════════════════════════════════════════════════════════╣
║ MOVEMENT MAP                                                        ║
║   M1 Discovery   →   M2 Metrics   →   M3 Coverage                   ║
║   Beats 1.1–1.4      Beats 2.1–2.4      Beats 3.1–3.1               ║
...
║ Beat Mov Handler                      LOC  Sz  Cov  Risk  Baton     ║
║ ─────────────────────────────────────────────────────────────────── ║
║ 1.1  M1  copyToClipboard                11  S    60% MED   start    ║
║ 1.2  M1  getSelectedId                  11  S    59% HIGH  metrics  ║
║ 1.3  M1  copy                           11  S    82% LOW   metrics  ║
║ 1.4  M1  notifyCopyComplete             11  S    75% LOW   metrics  ║
║      🎭 Data Baton ▸ handoff: template + CSS metrics                ║
║ 2.1  M2  serializeElement                8  S    81% LOW   style    ║
║ 2.2  M2  serializeSelectedComponent      8  S    78% LOW   style    ║
╠════════════════════════ HANDLER PORTFOLIO METRICS ═════════════════╣
...
║ Package: canvas-component                                           ║
║ Scope : 1 Symphony · 3 Movements · 6 Beats · 6 Handlers             ║
║ Health: 59 LOC · Avg Cov 75% · Size Band: SMALL · Risk: MEDIUM      ║
╠════════════════════════════════════════════════════════════════════╣
║ MOVEMENT MAP                                                        ║
║   M1 Discovery   →   M2 Metrics   →   M3 Coverage                   ║
║   Beats 1.1–1.4      Beats 2.1–2.4      Beats 3.1–3.1               ║
...
║ Beat Mov Handler                      LOC  Sz  Cov  Risk  Baton     ║
║ ─────────────────────────────────────────────────────────────────── ║
║ 1.1  M1  deleteComponent                10  S    85% LOW   start    ║
║ 1.2  M1  delete                         10  S    77% LOW   metrics  ║
║ 1.3  M1  hideOverlaysForId               9  S    84% LOW   metrics  ║
║ 1.4  M1  publishDeleted                 11  S    75% LOW   metrics  ║
║      🎭 Data Baton ▸ handoff: template + CSS metrics                ║
║ 2.1  M2  resolveId                       9  S    70% MED   style    ║
║ 2.2  M2  routeDeleteRequest              9  S    63% MED   style    ║
╠════════════════════════ HANDLER PORTFOLIO METRICS ═════════════════╣
...
║ Beat Mov Handler                      LOC  Sz  Cov  Risk  Baton     ║
║ ─────────────────────────────────────────────────────────────────── ║
║ 1.1  M1  calculatePastePosition         11  S    68% MED   start    ║
║ 1.2  M1  createPastedComponent          11  S    71% MED   metrics  ║
║ 1.3  M1  deserializeComponentData       11  S    75% LOW   metrics  ║
║ 1.4  M1  paste                           9  S    76% LOW   metrics  ║
║      🎭 Data Baton ▸ handoff: template + CSS metrics                ║
║ 2.1  M2  notifyPasteComplete            11  S    57% HIGH  style    ║
║ 2.2  M2  readFromClipboard              10  S    73% MED   style    ║
╠════════════════════════ HANDLER PORTFOLIO METRICS ═════════════════╣
...
║ Health: 39 LOC · Avg Cov 75% · Size Band: TINY · Risk: MEDIUM       ║
╠════════════════════════════════════════════════════════════════════╣
║ MOVEMENT MAP                                                        ║
║   M1 Discovery   →   M2 Metrics   →   M3 Coverage                   ║
║   Beats 1.1–1.4      Beats 2.1–2.4      Beats 3.1–3.1               ║
...
║ Beat Mov Handler                      LOC  Sz  Cov  Risk  Baton     ║
║ ─────────────────────────────────────────────────────────────────── ║
║ 1.1  M1  getClipboardText               10  S    63% MED   start    ║
║ 1.2  M1  safeGetStorage                 11  S    78% LOW   metrics  ║
║ 1.3  M1  safeSetStorage                 11  S    76% LOW   metrics  ║
║ 1.4  M1  setClipboardText               12  S    76% LOW   metrics  ║
╠════════════════════════ HANDLER PORTFOLIO METRICS ═════════════════╣
...
║ Health: 29 LOC · Avg Cov 75% · Size Band: TINY · Risk: MEDIUM       ║
╠════════════════════════════════════════════════════════════════════╣
║ MOVEMENT MAP                                                        ║
║   M1 Discovery   →   M2 Metrics   →   M3 Coverage                   ║
║   Beats 1.1–1.4      Beats 2.1–2.4      Beats 3.1–3.1               ║
...
║ Beat Mov Handler                      LOC  Sz  Cov  Risk  Baton     ║
║ ─────────────────────────────────────────────────────────────────── ║
║ 1.1  M1  addClass                       11  S    64% MED   start    ║
║ 1.2  M1  removeClass                     9  S    67% MED   metrics  ║
║ 1.3  M1  classes.symphony               11  S    59% HIGH  metrics  ║
╠════════════════════════ HANDLER PORTFOLIO METRICS ═════════════════╣
...
║ Health: 20 LOC · Avg Cov 75% · Size Band: TINY · Risk: MEDIUM       ║
╠════════════════════════════════════════════════════════════════════╣
║ MOVEMENT MAP                                                        ║
║   M1 Discovery   →   M2 Metrics   →   M3 Coverage                   ║
║   Beats 1.1–1.4      Beats 2.1–2.4      Beats 3.1–3.1               ║
...
║ Beat Mov Handler                      LOC  Sz  Cov  Risk  Baton     ║
║ ─────────────────────────────────────────────────────────────────── ║
║ 1.1  M1  deriveSelectionModel            9  S    57% HIGH  start    ║
║ 1.2  M1  selection.symphony              8  S    75% LOW   metrics  ║
╠════════════════════════ HANDLER PORTFOLIO METRICS ═════════════════╣
...
║ Package: library                                                    ║
║ Scope : 1 Symphony · 3 Movements · 2 Beats · 2 Handlers             ║
║ Health: 20 LOC · Avg Cov 75% · Size Band: TINY · Risk: LOW          ║
╠════════════════════════════════════════════════════════════════════╣
║ MOVEMENT MAP                                                        ║
║   M1 Discovery   →   M2 Metrics   →   M3 Coverage                   ║
║   Beats 1.1–1.4      Beats 2.1–2.4      Beats 3.1–3.1               ║
...
║ Beat Mov Handler                      LOC  Sz  Cov  Risk  Baton     ║
║ ─────────────────────────────────────────────────────────────────── ║
║ 1.1  M1  load.symphony                  12  S    63% MED   start    ║
║ 1.2  M1  mapJsonComponentToTemplateCom  11  S    80% LOW   metrics  ║
╠════════════════════════ HANDLER PORTFOLIO METRICS ═════════════════╣
...
║ Health: 10 LOC · Avg Cov 75% · Size Band: TINY · Risk: LOW          ║
╠════════════════════════════════════════════════════════════════════╣
║ MOVEMENT MAP                                                        ║
║   M1 Discovery   →   M2 Metrics   →   M3 Coverage                   ║
║   Beats 1.1–1.4      Beats 2.1–2.4      Beats 3.1–3.1               ║
...
║ Beat Mov Handler                      LOC  Sz  Cov  Risk  Baton     ║
║ ─────────────────────────────────────────────────────────────────── ║
║ 1.1  M1  drop.container.symphony        12  S    67% MED   start    ║
╠════════════════════════ HANDLER PORTFOLIO METRICS ═════════════════╣
...
║ Beat Mov Handler                      LOC  Sz  Cov  Risk  Baton     ║
║ ─────────────────────────────────────────────────────────────────── ║
║ 1.1  M1  drop.symphony                   9  S    81% LOW   start    ║
╠════════════════════════ HANDLER PORTFOLIO METRICS ═════════════════╣
...
║   Effort : medium                                      ║
║   Rationale: Current coverage: 74.7%. Target: 80%+     ║
...
ANALYSIS EXECUTION SUMMARY:
  ...
  ✅ Measured: Test coverage (avg 74.7%)
...
NEXT ACTIONS:
  ...
  → Improve test coverage to 80%+ (currently 74.7%)
...
**Last Scan**: 2025-11-29T18:36:19.241Z
...
|------|----------|--------|-----|--------|
| Statements | 74.73% | 80% | -5.3% | 🟡 Needs Improvement |
| Branches | 71.37% | 75% | -3.6% | 🔴 Off-track |
| Functions | 87.25% | 80% | 7.3% | 🟢 Close |
| Lines | 78.88% | 80% | -1.1% | 🟡 Needs Improvement |
...
**Last Scan**: 2025-11-29T18:36:19.003Z
...
**Generated**: 2025-11-29T18:36:19.017Z
...
**Global Coverage**: 81.04% statements
...
|----------|-------|---|--------|
| Well-Covered (80%+) | 99 | 50.8% | ✅ |
| Partially-Covered (50-79%) | 96 | 49.2% | ⚠️ |
| Poorly-Covered (1-49%) | 0 | 0.0% | ⚠️ |
| Uncovered (0%) | 0 | 0.0% | ❌ |

**Average Handler Coverage**: 77.96%
...
|------|--------------|----------|--------|
| beat-4-dependencies | 81.2% | 28 | ✅ |
| beat-2a-baseline-metrics | 81.1% | 43 | ✅ |
| beat-3-structure | 81.09% | 84 | ✅ |
| beat-1-discovery | 65.75% | 40 | ⚠️ |

### ✅ Well-Tested Handlers (Coverage >= 80%)
| Handler | Coverage | Beat |
|---------|----------|------|
| processBeat | 85.97% | beat-3-structure |
| items | 85.96% | beat-4-dependencies |
| ghost | 85.89% | beat-3-structure |
| startDrag | 85.87% | beat-3-structure |
| enqueueSequence | 85.83% | beat-3-structure |
| EventRouter | 85.78% | beat-2a-baseline-metrics |
| getCurrentTheme | 85.72% | beat-3-structure |
| awaitRefresh | 85.65% | beat-3-structure |

**Measurement**: Source='measured' (test coverage analysis with handler-beat correlation)
**Timestamp**: 2025-11-29T18:36:20.491Z
...
- Timestamp: 2025-11-29T18:36:20.796Z
...
**Current Baseline**: 2025-11-29T18:36:21.098Z
...
| Coverage (avg) | 81.75% | 36.60% | - | Monitoring | - |
| Maintainability | 75.64/100 | - | - | Baseline | - |
...
|--------|---------|--------|-----|--------|
| Statements | 73.64% | 85% | 11.36% | 🟡 Close |
| Branches | 89.86% | 85% | -4.86% | 🟡 Close |
| Functions | 80.64% | 90% | 9.36% | 🟡 Close |
| Lines | 86.08% | 85% | -1.08% | ✅ On-target |
...
**Current Maintainability Index**: 75.64/100
...
**Timestamp**: 2025-11-29T18:36:21.105Z
...
✓ Conformity (87.50%) ✅
✓ Coverage - Orchestration Suite (74.73%) ❌
...
- **JSON Analysis**: renderx-web-orchestration-code-analysis-2025-11-29T18-36-17-438Z.json
- **Coverage Summary**: renderx-web-orchestration-coverage-summary-2025-11-29T18-36-17-438Z.json
- **Per-Beat Metrics**: renderx-web-orchestration-per-beat-metrics-2025-11-29T18-36-17-438Z.csv
- **Trend Analysis**: renderx-web-orchestration-trends-2025-11-29T18-36-17-438Z.json
