# Orchestration Registry Audit Pipeline Code Analysis Report

**Generated**: 2025-11-30T09:24:19.730Z  
**Codebase**: orchestration-registry-audit-pipeline  
...
| Test Coverage | 81.44% | ✅ GOOD| Risk: LOW|
| Maintainability | 62.14/100 | 🟡 FAIR| Grade: B|
...
╔══════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗
║                    SYMPHONIC CODE ANALYSIS ARCHITECTURE - ORCHESTRATION REGISTRY AUDIT PIPELINE             ║
...
│  ═════════════════════════════════════════════════════════════════════════════════════════════════════════════   │
│  │ Total Files: 26  │ Total LOC: 2147  │ Handlers: 69 │ Avg LOC/Handler: 31.12│ Coverage: 81.44% │           │
│  ╰─────────────────────────────────────────────────────────────────────────────────────────────────────────────  │
└─────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘
...
║ Domain : orchestration-registry-audit-pipeline                      ║
║ Package: build-scripts                                              ║
║ Scope : 1 Symphony · 10 Movements · 37 Beats · 37 Handlers          ║
║ Health: 1151 LOC · Avg Cov 81% · Size Band: XL · Risk: LOW          ║
╠════════════════════════════════════════════════════════════════════╣
║ MOVEMENT MAP                                                        ║
...
║ ─────────────────────────────────────────────────────────────────── ║
║ 1.1  M1  aggregateGovernanceResults     33  M    83% MED   start    ║
║ 1.2  M1  analyzeTestCoverage            31  M    75% MED   metrics  ║
║ 1.3  M1  calculateConformityScore       32  M    68% MED   metrics  ║
║ 1.4  M1  catalogBeatsFromJSON           36  M    77% MED   metrics  ║
║      🎭 Data Baton ▸ handoff: template + CSS metrics                ║
║ 2.1  M2  concludeGovernanceEnforcement  29  M    64% MED   style    ║
║ 2.2  M2  createCodeMappings             32  M    86% MED   style    ║
║ 2.3  M2  createMarkdownMappings         32  M    73% MED   style    ║
║ 2.4  M2  createTestMappings             32  M    83% MED   style    ║
║ 3.1  M3  detectMarkdownContradictions   33  M    63% MED   import   ║
║ 3.2  M3  detectOrphanHandlers           25  S    87% LOW   import   ║
║ 3.3  M3  extractFactsFromJSON           32  M    85% MED   import   ║
║ 3.4  M3  generateGovernanceReport       30  M    72% MED   payload  ║
║ 4.1  M4  identifyMarkdownFiles          34  M    65% MED   payload  ║
║ 4.2  M4  identifyUncoveredBeats         37  M    82% MED   payload  ║
║ 4.3  M4  indexBeatsFromJSON             33  M    72% MED   payload  ║
║ 4.4  M4  indexTestFiles                 37  M    75% MED   payload  ║
║ 5.1  M5  loadHandlerImplementations     37  M    82% MED   payload  ║
║ 5.2  M5  loadJSONDefinitions            31  M    72% MED   payload  ║
║ 5.3  M5  makeGovernanceDecision         26  M    84% MED   payload  ║
║ 5.4  M5  reportAuditability             28  M    64% MED   payload  ║
║ 6.1  M6  reportHandlerMapping           31  M    84% MED   payload  ║
║ 6.2  M6  reportJSONValidation           37  M    85% MED   payload  ║
║ 6.3  M6  reportMarkdownConsistency      36  M    70% MED   payload  ║
║ 6.4  M6  reportTestCoverage             35  M    63% MED   payload  ║
║ 7.1  M7  startAuditabilityVerification  35  M    79% MED   payload  ║
║ 7.2  M7  startConformityAnalysis        28  M    68% MED   payload  ║
║ 7.3  M7  startHandlerMappingVerificati  25  S    74% MED   payload  ║
║ 7.4  M7  startMarkdownConsistencyCheck  32  M    62% MED   payload  ║
║ 8.1  M8  startTestCoverageVerification  34  M    79% MED   payload  ║
║ 8.2  M8  summarizeViolations            32  M    77% MED   payload  ║
║ 8.3  M8  validateJSONSchemaStructure    31  M    78% MED   payload  ║
║ 8.4  M8  validateOrchestrationDomainsR  35  M    84% MED   payload  ║
║ 9.1  M9  validateSchemaSection          28  M    90% MED   payload  ║
║ 9.2  M9  validateSymphonyFiles          37  M    78% MED   payload  ║
║ 9.3  M9  verifyBeatHandlerMapping       36  M    74% MED   payload  ║
║ 9.4  M9  verifyChainCompleteness        29  M    87% MED   payload  ║
║ 10.1 M10 verifyFactsInMarkdown          29  M    65% MED   payload  ║
╠════════════════════════ HANDLER PORTFOLIO METRICS ═════════════════╣
║ Size Bands    : Tiny 0 · Small 0 · Medium 37 · Large 0 · XL 0       ║
║ Coverage Dist.: 0–30% 0 · 30–60% 0 · 60–80% 24 · 80–100% 13         ║
...
║ Health: 498 LOC · Avg Cov 81% · Size Band: LARGE · Risk: LOW        ║
╠════════════════════════════════════════════════════════════════════╣
║ MOVEMENT MAP                                                        ║
║   M1 Discovery   →   M2 Metrics   →   M3 Coverage                   ║
║   Beats 1.1–1.4      Beats 2.1–2.4      Beats 3.1–3.4               ║
...
║ Beat Mov Handler                      LOC  Sz  Cov  Risk  Baton     ║
║ ─────────────────────────────────────────────────────────────────── ║
║ 1.1  M1  calculateConformityScore       28  M    75% MED   start    ║
║ 1.2  M1  generateAnalysisReport         26  M    90% MED   metrics  ║
║ 1.3  M1  generateTrendReport            26  M    75% MED   metrics  ║
║ 1.4  M1  validateHandlerMapping         35  M    89% MED   metrics  ║
║      🎭 Data Baton ▸ handoff: template + CSS metrics                ║
║ 2.1  M2  calculateGapAnalysis           29  M    69% MED   style    ║
║ 2.2  M2  measureBranchCoverage          31  M    69% MED   style    ║
║ 2.3  M2  measureFunctionCoverage        30  M    70% MED   style    ║
║ 2.4  M2  measureStatementCoverage       26  M    66% MED   style    ║
║ 3.1  M3  collectBaseline                35  M    85% MED   import   ║
║ 3.2  M3  discoverSourceCode             31  M    88% MED   import   ║
║ 3.3  M3  mapBeatsToCode                 31  M    70% MED   import   ║
║ 3.4  M3  scanOrchestrationFiles         37  M    64% MED   payload  ║
║ 4.1  M4  analyzeComplexity              31  M    81% MED   payload  ║
║ 4.2  M4  calculateMaintainability       32  M    91% MED   payload  ║
║ 4.3  M4  countLinesOfCode               35  M    81% MED   payload  ║
║ 4.4  M4  detectDuplication              28  M    85% MED   payload  ║
╠════════════════════════ HANDLER PORTFOLIO METRICS ═════════════════╣
║ Size Bands    : Tiny 0 · Small 0 · Medium 16 · Large 0 · XL 0       ║
║ Coverage Dist.: 0–30% 0 · 30–60% 0 · 60–80% 8 · 80–100% 8           ║
...
║ Health: 31 LOC · Avg Cov 81% · Size Band: TINY · Risk: LOW          ║
╠════════════════════════════════════════════════════════════════════╣
║ MOVEMENT MAP                                                        ║
║   M1 Discovery   →   M2 Metrics   →   M3 Coverage                   ║
...
║ Beat Mov Handler                      LOC  Sz  Cov  Risk  Baton     ║
║ ─────────────────────────────────────────────────────────────────── ║
║ 1.1  M1  fractalNarrator                28  M    84% MED   start    ║
╠════════════════════════ HANDLER PORTFOLIO METRICS ═════════════════╣
...
**Last Scan**: 2025-11-30T09:24:18.450Z
...
**Scope**: Full `orchestration-registry-audit-pipeline` domain - all source files in `scripts/` analyzed

### Coverage Metrics
| Type | Coverage | Target | Gap | Status |
|------|----------|--------|-----|--------|
| Statements | 81.44% | 80% | 1.4% | ✅ On-target |
| Branches | 78.81% | 75% | 3.8% | 🟡 Needs Improvement |
| Functions | 76.21% | 80% | -3.8% | 🔴 Off-track |
| Lines | 81.12% | 80% | 1.1% | 🟡 Needs Improvement |
...
**Last Scan**: 2025-11-30T09:24:18.138Z
...
**Global Coverage**: 75.22% statements
...
|----------|-------|---|--------|
| Well-Covered (80%+) | 1 | 0.5% | ✅ |
| Partially-Covered (50-79%) | 194 | 99.5% | ⚠️ |
| Poorly-Covered (1-49%) | 0 | 0.0% | ⚠️ |
| Uncovered (0%) | 0 | 0.0% | ❌ |

**Average Handler Coverage**: 72.37%
...
|------|--------------|----------|--------|
| beat-4-dependencies | 75.72% | 28 | ⚠️ |
| beat-2a-baseline-metrics | 75.4% | 43 | ⚠️ |
| beat-3-structure | 75.37% | 84 | ⚠️ |
| beat-1-discovery | 60.47% | 40 | ⚠️ |

### ✅ Well-Tested Handlers (Coverage >= 80%)
| Handler | Coverage | Beat |
|---------|----------|------|
| classes | 80.21% | beat-3-structure |

**Measurement**: Source='measured' (test coverage analysis with handler-beat correlation)
**Timestamp**: 2025-11-30T09:24:19.107Z
...
- Timestamp: 2025-11-30T09:24:19.398Z
...
**Current Baseline**: 2025-11-30T09:24:19.720Z
...
| Coverage (avg) | 82.61% | 40.99% | - | Monitoring | - |
| Maintainability | 73.38/100 | - | - | Baseline | - |
...
|--------|---------|--------|-----|--------|
| Statements | 79.24% | 85% | 5.76% | 🟡 Close |
| Branches | 85.97% | 85% | -0.97% | 🟡 Close |
| Functions | 78.27% | 90% | 11.73% | 🟡 Close |
| Lines | 76.21% | 85% | 8.79% | ✅ On-target |
...
**Current Maintainability Index**: 73.38/100
...
**Timestamp**: 2025-11-30T09:24:19.729Z
...
✓ Conformity (87.50%) ✅
✓ Coverage - Orchestration Suite (81.44%) ✅
...
- **JSON Analysis**: orchestration-registry-audit-pipeline-code-analysis-2025-11-30T09-24-16-582Z.json
- **Coverage Summary**: orchestration-registry-audit-pipeline-coverage-summary-2025-11-30T09-24-16-582Z.json
- **Per-Beat Metrics**: orchestration-registry-audit-pipeline-per-beat-metrics-2025-11-30T09-24-16-582Z.csv
- **Trend Analysis**: orchestration-registry-audit-pipeline-trends-2025-11-30T09-24-16-582Z.json
