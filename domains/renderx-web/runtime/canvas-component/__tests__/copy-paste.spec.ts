...
import { handlers as selectHandlers } from "@renderx-web/canvas-component/symphonies/select/select.symphony.ts";
import { handlers as copyHandlers } from "@renderx-web/canvas-component/symphonies/copy/copy.symphony.ts";
import { handlers as pasteHandlers } from "@renderx-web/canvas-component/symphonies/paste/paste.symphony.ts";
