...
import { ControlPanel, register } from '@renderx-web/control-panel';
import { handlers as selectionHandlers } from '@renderx-web/control-panel/symphonies/selection/selection.symphony';

describe('@renderx-web/control-panel package exports', () => {
  let ctx: any;
  beforeEach(() => {
    ctx = {
