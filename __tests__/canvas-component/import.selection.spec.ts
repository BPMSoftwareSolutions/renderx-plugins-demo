...
describe("canvas-component import: selection forwarding", () => {
  ...
  it("clicking imported node plays canvas.component.select", async () => {
    ...
    ctx.payload.uiFileContent = {
      ...
      cssClasses: {},
      components: [
        { id: "c1", type: "container", template: { tag: "div", classRefs: ["rx-comp","rx-container"] }, layout: { x: 0, y: 0, width: 200, height: 100 }, parentId: null, siblingIndex: 0 },
        { id: "b1", type: "button", template: { tag: "button", classRefs: ["rx-comp","rx-button"] }, layout: { x: 10, y: 10, width: 80, height: 30 }, parentId: "c1", siblingIndex: 0 },
      ]
    };
