...
import type { ControlPanelConfig, SelectedElement } from '../../plugins/control-panel/types/control-panel.types';
...
const baseConfig: ControlPanelConfig = {
  ...
  defaultSections: [
    ...
    { id: 'styling', title: 'Styling', icon: '🎨', order: 3, collapsible: true, defaultExpanded: false }
  ],
  fieldTypes: {},
