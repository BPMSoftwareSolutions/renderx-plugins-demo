...
describe("@renderx-plugins/library D handlers (host wrapper)", () => {
  beforeEach(() => {
    global.window = global.window || {};
    global.window.RenderX = {};
  });

  it("loadComponents uses Host SDK inventory when available", async () => {
  ...
  it("notifyUi calls onComponentsLoaded with payload components", () => {
