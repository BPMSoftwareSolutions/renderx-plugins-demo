function t(){if(typeof document>"u")return;const r="rx-components-styles";let e=document.getElementById(r);e||(e=document.createElement("style"),e.id=r,document.head.appendChild(e)),(e.textContent||"").includes("rx-selection-overlay")||e.appendChild(document.createTextNode(`
