...
- **Desktop:** 3,268 lines of code
- **Parity:** 3268.0% of web implementation
...
- **Lines:** 100
- **Props:** None
- **Hooks:** useControlPanelActions, useControlPanelState, useMemo, useEffect, React.useEffect
- **CSS Classes:** 3
- **Features:** None
