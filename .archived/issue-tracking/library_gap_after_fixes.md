...
- **Desktop:** 3,099 lines of code
- **Parity:** 198.4% of web implementation
...
- **Props:** setShowAIChat] = React.useState(false);
  const safeItems = Array.isArray(items) ? items, {
          onComponentsLoaded
- **Hooks:** React.useEffect, useEffect, useCallback, React.useCallback, React.useState
- **CSS Classes:** 18
