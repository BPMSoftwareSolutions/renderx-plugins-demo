...
Web shows AI unavailable hint (💡) when AI is not configured; desktop lacks equivalent contextual notice.
...
- **Desktop:** Desktop shows: 🧩, Component description, 📄 View JSON, 🔄 Try Again, Component JSON
...
### 🟠 CONDITIONAL UI PARITY in LibraryPanel
...
### 🟡 PLUGIN-WIDE MISSING AI AVAILABILITY HINT
